              ...
              >
                <div className="bg-white text-gray-800 p-4 md:p-6 lg:p-8 rounded-lg h-full">
                  ...
                  <div className="flex items-center gap-3 md:gap-4">
                    <img
                      src="https://s3-alpha-sig.figma.com/img/701a/f49b/47caa9bbf738b70c44ef13c2c615ed36?Expires=1737936000&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=kUo1P7xw3d3d-3KMKvgQJovVy9AMHod9GAx7x-G5dvS9jPdHF2wad9lTT1RlcXdHro6DWPcKgouje8elwrntwEmeh7uAdB2kUI1dMOBWvIW1T94wl1XYXo18~cJPWvPcNQtqNMAHFSZih-6KASon~iXQQtFcAH9sFvdL8UQKhVxrUVLQcSUNh~EQJ4F-yT1KW1K00FRPzhYfzCSu~DIrgtFy2j0bMAJmi61jQ1fD-57jqFavEtXRKrzYZw0EcWzMg0ALZbTlikbnVXi11ijxrswIuLKPnbQ2czQWVrcSxJG6IcaZ-f3KshU~5sjFLMJq5Qa4Rb3n5VGxL5c-aVonfg__"
                      alt={testimonial.author}
